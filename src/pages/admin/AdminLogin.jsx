...
import { Mail, KeyRound, Server, AlertCircle, Loader2, Shield, ShieldCheck, Zap, Radio } from 'lucide-react';
...
export const AdminLogin = () => {
  ...
  const handleAdminLogin = async (e) => {
    ...
    try {
      // Production: verify against Supabase Auth and ensure the user row has admin role
      if (!isDemoMode) {
