// Calculates lunar calendar data for crowd prediction multipliers
...
export const panchangCalendarEngine = {
  ...
  calculateAstronomicalTithi(date = new Date()) {
    ...
    // Calculate approximate lunisolar angle
    const epoch = new Date(2026, 0, 1).getTime();
    const daysElapsed = (istDate.getTime() - epoch) / (1000 * 60 * 60 * 24);
    
    // Synodic month is roughly 29.53 days
  ...
  // Get multiplier and festival status
